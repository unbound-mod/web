...
export function Page() {
	return <div id='home-page' class='relative w-full mt-32 min-h-dvh'>
		<div class='relative items-center gap-6 flex flex-col h-[100vh] w-full'>
			{/* <Button variant='cta'>Begin your journey</Button> */}
			<div class='mt-32 relative gap-4 md:gap-6 slide-in-from-bottom-36 zoom-in-90 animate-in duration-700 fade-in w-full items-center flex flex-col after:absolute after:z-10 after:bg-[linear-gradient(to_bottom,transparent_40%,hsl(var(--bg)/0.75)_60%,hsl(var(--bg)/1)_90%)] after:inset-0  after:pointer-events-none'>
				...
				<div class='flex gap-4'>
					...
					<Button class='min-w-40' variant='opposite'>
						Documentation
					</Button>
				</div>
